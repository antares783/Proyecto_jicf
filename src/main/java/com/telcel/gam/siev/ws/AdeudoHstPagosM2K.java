...
/**
 * <p>Clase Java para adeudoHstPagosM2K complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="adeudoHstPagosM2K"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "adeudoHstPagosM2K", propOrder = {
    "xml"
})
public class AdeudoHstPagosM2K {
